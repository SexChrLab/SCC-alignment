...
snakemake -s rnaseq_data_processing_salmon.snakefile --rerun-incomplete --latency-wait=60 -j 100 --cluster "sbatch -n 2 -p serial --mem=32G --mail-type=FAIL --mail-user=splaisie@asu.edu"
