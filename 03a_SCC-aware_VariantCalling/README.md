...
# Sex chromosome complement (SCC)-aware pipeline for variant calling
The rules in the SCC-aware variant calling pipeline SNPs_XX.snakefile and SNPs_XY are as follows:
