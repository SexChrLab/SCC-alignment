...
#bwa_map_reads rule
		expand("mapped/Y/{Y}.bam", Y=Y_samples),
#index_stat rules
...
rule bwa_mapping_Y:
	...
	shell:
		"""
		bwa mem -t {params.threads} -R '@RG\\tID:{params.id}\\tSM:{params.sm}\\tLB:{params.lb}\\tPU:{params.pu}\\tPL:{params.pl}' {params.Y_genome} {input.fq1} {input.fq2} | samblaster | samtools fixmate -@ 4 - - | samtools sort -@ 4 -O bam - -o {output};
		"""
